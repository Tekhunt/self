      ...
      <section class="mb-32">
        <div class="flex flex-wrap">
          <div class="mb-10 w-full shrink-0 grow-0 basis-auto md:mb-0 md:w-6/12 md:px-3 lg:px-6">
            ...
            <p class="mb-6  ">
            As a Fullstack Engineer and Machine Learning enthusiast, I'm passionate about building innovative solutions that blend cutting-edge technology and creativity. Feel free to reach out to me for collaboration, questions, or just to connect!
            </p>
            <p class="mb-2  ">
